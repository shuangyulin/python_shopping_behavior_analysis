<template>
	<div :style='{"padding":"30px"}'>
		<el-form
			...
			label-width="180px"
		>
			<el-form-item :style='{"border":"1px solid #eee","padding":"2px 20px","margin":"0 0 -1px 0","borderWidth":"1px 1px"}' label="原密码" prop="password">
				<el-input v-model="ruleForm.password" ></el-input>
			</el-form-item>
			<el-form-item :style='{"border":"1px solid #eee","padding":"2px 20px","margin":"0 0 -1px 0","borderWidth":"1px 1px"}' label="新密码" prop="newpassword">
				<el-input v-model="ruleForm.newpassword" ></el-input>
			</el-form-item>
			<el-form-item :style='{"border":"1px solid #eee","padding":"2px 20px","margin":"0 0 -1px 0","borderWidth":"1px 1px"}' label="确认密码" prop="repassword">
