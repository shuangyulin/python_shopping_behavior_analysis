<template>
	<div class="content" :style='{"alignContent":"flex-start","overflow":"hidden","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20240110/9700676031ec41c392ecc55b63cd275e.png) no-repeat center top / 100% 100%","display":"flex","width":"100%","position":"relative","height":"100vh"}'>
		<div id="particles"></div>
		<div :style='{"width":"98%","margin":"10px auto","position":"relative","background":"url(http://codegen.caihongy.cn/20240110/900b137dc40f4905b7772288698981c2.png) no-repeat center bottom / 100% 100%","height":"60px"}'>
			<!-- 标题 -->
			<div :style='{"margin":"0 auto","color":"rgba(37,135,17,1)","textAlign":"center","background":"linear-gradient(149deg, rgba(21,255,0,1) 0%, rgba(255,255,255,1) 50%, rgba(3,255,162,1) 100%)","-webkitTextFillColor":"transparent","width":"65%","lineHeight":"60px","fontSize":"26px","fontWeight":"600","-webkitBackgroundClip":"text","height":"60px"}'>欢迎使用 {{this.$project.projectName}}</div>
			<!-- 时间 -->
			<div :style='{"top":"10px","color":"rgba(37,135,17,1)","display":"inline-block","lineHeight":"40px","fontSize":"14px","position":"absolute","right":"60px","height":"64px"}'>{{ dates }} <span @click="backClick" style="cursor:pointer;padding: 0 0 0 8px;">管理界面</span></div>
		</div>
		<div :style='{"width":"100%","padding":"20px 20px 0","overflow":"hidden","display":"flex","height":"calc(100vh - 95px)"}'>
			<div :style='{"width":"30%","padding":"0 0px","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts1">
					<div :style='{"width":"100%","padding":"0 16px","margin":"0 0 10px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20240105/a89b780f705a4bb88abe1aededf8bde8.png) no-repeat left top,url(http://codegen.caihongy.cn/20240105/a89b780f705a4bb88abe1aededf8bde8.png) no-repeat left bottom,url(http://codegen.caihongy.cn/20240105/1e8cd97a1f894c49ba49cba0217fefa6.png) no-repeat left center","height":"36px"}'>
						<div :style='{"color":"rgba(69,166,48,1)","fontSize":"14px","lineHeight":"36px"}'>
							商品类型
						</div>
					</div>
					<div :style='{"width":"100%","padding":"0 16px","height":"calc(100% - 46px)"}'>
						<div id="shangpinxinxiChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts3">
					<div :style='{"width":"100%","padding":"0 16px","margin":"0 0 10px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20240105/a89b780f705a4bb88abe1aededf8bde8.png) no-repeat left top,url(http://codegen.caihongy.cn/20240105/a89b780f705a4bb88abe1aededf8bde8.png) no-repeat left bottom,url(http://codegen.caihongy.cn/20240105/1e8cd97a1f894c49ba49cba0217fefa6.png) no-repeat left center","height":"36px"}'>
					...
					<div :style='{"width":"100%","padding":"0 16px","height":"calc(100% - 46px)"}'>
						<div id="shangpinxinxiChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"width":"100%","padding":"0 16px","margin":"0 0 10px","textAlign":"left","background":"url(http://codegen.caihongy.cn/20240105/a89b780f705a4bb88abe1aededf8bde8.png) no-repeat left top,url(http://codegen.caihongy.cn/20240105/a89b780f705a4bb88abe1aededf8bde8.png) no-repeat left bottom,url(http://codegen.caihongy.cn/20240105/1e8cd97a1f894c49ba49cba0217fefa6.png) no-repeat left center","height":"36px"}'>
					...
					<div :style='{"width":"100%","padding":"0 16px","height":"calc(100% - 46px)"}'>
						<div id="gouwurizhiChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
			<div :style='{"width":"40%","padding":"0 20px","flexWrap":"wrap","display":"flex"}'>
				<div v-if="systemIntroductionDetail" :style='{"padding":"0","margin":"0 0 20px","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"calc(46% - 140px)"}'>
					...
					<div :style='{"border":"0px solid rgba(37,135,17,.2)","padding":"0","margin":"0 0 0 20px","overflow":"hidden","color":"#fff","flex":1,"background":"none","lineHeight":"1.5","fontSize":"14px","height":"100%"}' v-html="systemIntroductionDetail.content"></div>
				</div>
				<!-- 统计 -->
				<div :style='{"padding":"0","margin":"0 0 20px","color":"rgba(69,166,48,1)","alignItems":"center","display":"flex","justifyContent":" center","alignContent":"center","background":"none","width":"100%","fontSize":"14px","height":"100px","order":"1","zIndex":"9"}'>

					<div :style='{"margin":"0 10px 0 0","borderColor":"rgba(37,135,17,.2)","alignItems":"center","background":"url(http://codegen.caihongy.cn/20240105/a89b780f705a4bb88abe1aededf8bde8.png) no-repeat left top,url(http://codegen.caihongy.cn/20240105/a89b780f705a4bb88abe1aededf8bde8.png) no-repeat left bottom,url(http://codegen.caihongy.cn/20240105/a89b780f705a4bb88abe1aededf8bde8.png) no-repeat right top,url(http://codegen.caihongy.cn/20240105/a89b780f705a4bb88abe1aededf8bde8.png) no-repeat right bottom,rgba(37,135,17,.1)","flexDirection":"column","borderWidth":"1px 0","display":"flex","width":"150px","borderStyle":"solid","justifyContent":"center","height":"100px"}'>
						<div :style='{"width":"12px","margin":"0 0 0 20px","background":"#2097db","display":"none","height":"12px"}'></div>
						<div :style='{"padding":"0 0px","alignItems":"center","flexDirection":"column","display":"flex"}'>
							<div :style='{"lineHeight":"32px","fontSize":"inherit","color":"inherit","height":"32px"}'>用户总数</div>
							<div :style='{"lineHeight":"32px","fontSize":"22px","color":"rgba(37,135,17,1)","fontWeight":"bold","height":"32px"}'>{{yonghuCount}}</div>
						</div>
					</div>

					<div :style='{"margin":"0 10px 0 0","borderColor":"rgba(37,135,17,.2)","alignItems":"center","background":"url(http://codegen.caihongy.cn/20240105/a89b780f705a4bb88abe1aededf8bde8.png) no-repeat left top,url(http://codegen.caihongy.cn/20240105/a89b780f705a4bb88abe1aededf8bde8.png) no-repeat left bottom,url(http://codegen.caihongy.cn/20240105/a89b780f705a4bb88abe1aededf8bde8.png) no-repeat right top,url(http://codegen.caihongy.cn/20240105/a89b780f705a4bb88abe1aededf8bde8.png) no-repeat right bottom,rgba(37,135,17,.1)","borderWidth":"1px 0","display":"flex","width":"150px","borderStyle":"solid","justifyContent":"center","height":"100px"}'>
						<div :style='{"width":"12px","margin":"0 0 0 20px","background":"yellow","display":"none","height":"12px"}'></div>
						<div :style='{"padding":"0 0px","alignItems":"center","flexDirection":"column","display":"flex"}'>
							<div :style='{"lineHeight":"32px","fontSize":"inherit","color":"inherit","height":"32px"}'>商品信息总数</div>
							<div :style='{"lineHeight":"32px","fontSize":"22px","color":"rgba(37,135,17,1)","fontWeight":"bold","height":"32px"}'>{{shangpinxinxiCount}}</div>
						</div>
					</div>
					...
					<div :style='{"margin":"0 10px 0 0","borderColor":"rgba(37,135,17,.2)","alignItems":"center","background":"url(http://codegen.caihongy.cn/20240105/a89b780f705a4bb88abe1aededf8bde8.png) no-repeat left top,url(http://codegen.caihongy.cn/20240105/a89b780f705a4bb88abe1aededf8bde8.png) no-repeat left bottom,url(http://codegen.caihongy.cn/20240105/a89b780f705a4bb88abe1aededf8bde8.png) no-repeat right top,url(http://codegen.caihongy.cn/20240105/a89b780f705a4bb88abe1aededf8bde8.png) no-repeat right bottom,rgba(37,135,17,.1)","borderWidth":"1px 0","display":"flex","width":"150px","borderStyle":"solid","justifyContent":"center","height":"100px"}'>
						<div :style='{"width":"12px","margin":"0 0 0 20px","background":"#2097db","display":"none","height":"12px"}'></div>
						<div :style='{"padding":"0 0px","alignItems":"center","flexDirection":"column","display":"flex"}'>
							<div :style='{"lineHeight":"32px","fontSize":"inherit","color":"inherit","height":"32px"}'>购物日志总数</div>
							<div :style='{"lineHeight":"32px","fontSize":"22px","color":"rgba(37,135,17,1)","fontWeight":"bold","height":"32px"}'>{{gouwurizhiCount}}</div>
						</div>
					</div>
				</div>
				<div class="tables">
					<div :style='{"padding":"0 16px","margin":"0 0 10px","borderColor":"#00cdd780","color":"rgba(69,166,48,1)","textAlign":"left","display":"inline-block","background":"url(http://codegen.caihongy.cn/20240105/a89b780f705a4bb88abe1aededf8bde8.png) no-repeat left top,url(http://codegen.caihongy.cn/20240105/a89b780f705a4bb88abe1aededf8bde8.png) no-repeat left bottom,url(http://codegen.caihongy.cn/20240105/1e8cd97a1f894c49ba49cba0217fefa6.png) no-repeat left center","borderWidth":"0","width":"100%","fontSize":"14px","lineHeight":"36px","borderStyle":"solid","height":"36px"}'>购物日志</div>
					<el-table :data="boardDataList" border :stripe="false" :style='{"width":"100%","padding":"0","borderColor":"rgba(37,135,17,.2)","borderStyle":"solid","borderWidth":"0px","background":"none"}'>
						<el-table-column :resizable="true" :sortable="false" prop="uid" label="购买者ID"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="goodsid" label="商品ID"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="goodstypeid" label="商品类目ID"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="userbehavior" label="行为类型"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="shijianchuo" label="时间戳"/>
						</el-table-column>
					</el-table>
				</div>
			</div>
			<div :style='{"width":"30%","padding":"0 0px","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts6">
					<div :style='{"width":"100%","padding":"0 16px","margin":"0 0 10px","textAlign":"right","background":"url(http://codegen.caihongy.cn/20240105/a89b780f705a4bb88abe1aededf8bde8.png) no-repeat right top,url(http://codegen.caihongy.cn/20240105/a89b780f705a4bb88abe1aededf8bde8.png) no-repeat right bottom,url(http://codegen.caihongy.cn/20240110/d67efc5f8e4643279f56742994e4ce3e.png) no-repeat right center","height":"36px"}'>
						<div :style='{"color":"rgba(69,166,48,1)","fontSize":"14px","lineHeight":"36px"}'>
							年龄统计
						</div>
					</div>
					<div :style='{"width":"100%","padding":"0 16px","height":"calc(100% - 46px)"}'>
						<div id="yonghuChart6" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts4">
					<div :style='{"width":"100%","padding":"0 16px","margin":"0 0 10px","textAlign":"right","background":"url(http://codegen.caihongy.cn/20240105/a89b780f705a4bb88abe1aededf8bde8.png) no-repeat right top,url(http://codegen.caihongy.cn/20240105/a89b780f705a4bb88abe1aededf8bde8.png) no-repeat right bottom,url(http://codegen.caihongy.cn/20240110/d67efc5f8e4643279f56742994e4ce3e.png) no-repeat right center","height":"36px"}'>
					...
					<div :style='{"width":"100%","padding":"0 16px","height":"calc(100% - 46px)"}'>
						<div id="shangpinxinxiChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts5">
					<div :style='{"width":"100%","padding":"0 16px","margin":"0 0 10px","textAlign":"right","background":"url(http://codegen.caihongy.cn/20240105/a89b780f705a4bb88abe1aededf8bde8.png) no-repeat right top,url(http://codegen.caihongy.cn/20240105/a89b780f705a4bb88abe1aededf8bde8.png) no-repeat right bottom,url(http://codegen.caihongy.cn/20240110/d67efc5f8e4643279f56742994e4ce3e.png) no-repeat right center","height":"36px"}'>
					...
					<div :style='{"width":"100%","padding":"0 16px","height":"calc(100% - 46px)"}'>
						<div id="shangpinxinxiChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
	...
	export default {
		data() {
			return {
				...
				gouwurizhiCount: 0,
				particlesJson: {"retina_detect":true,"particles":{"number":{"density":{"value_area":800,"enable":true},"value":30},"move":{"straight":false,"random":true,"bounce":false,"enable":true,"attract":{"rotateX":600,"enable":true,"rotateY":1200},"speed":1,"direction":"none","out_mode":"out"},"color":{"value":"#45a730"},"shape":{"image":{"width":100,"src":"img/github.svg","height":100},"polygon":{"nb_sides":5},"type":"edge","stroke":{"color":"#000000","width":0}},"size":{"anim":{"size_min":0.1,"sync":false,"enable":false,"speed":20},"random":true,"value":3},"line_linked":{"width":1,"distance":40,"color":"#ffffff","opacity":1,"enable":false},"opacity":{"anim":{"opacity_min":0.1,"sync":true,"enable":true,"speed":1},"random":true,"value":1}},"interactivity":{"detect_on":"canvas","events":{"resize":true,"onclick":{"mode":"repulse","enable":true},"onhover":{"mode":"grab","enable":false}},"modes":{"grab":{"distance":120,"line_linked":{"opacity":1}},"bubble":{"duration":2,"distance":400,"size":40,"opacity":8,"speed":3},"repulse":{"duration":0.4,"distance":300},"push":{"particles_nb":4},"remove":{"particles_nb":2}}}}
			};
		},
		mounted(){
			this.init();
		...
		created() {
			this.$nextTick(()=>{
				...
				setTimeout(()=>{
					...
					this.shangpinxinxiChat5();
					this.getgouwurizhiCount();
					this.gouwurizhiChat2();
				},500)
			})
		},
		methods:{
...
//统计接口1
			yonghuChat6() {
				this.$nextTick(()=>{
					...
					var yonghuChart6 = echarts.init(document.getElementById("yonghuChart6"),'macarons');
					this.$http({
...
//统计接口4
	shangpinxinxiChat5() {
	  this.$nextTick(()=>{
		...
		var shangpinxinxiChart5 = echarts.init(document.getElementById("shangpinxinxiChart5"),'macarons');
		this.$http({
			...
			if (data && data.code === 0) {
				...
				var option = {};
				let titleObj = this.line2?this.line2.title:this.line.title
				titleObj.text = '评论统计'
				
				const legendObj = this.line2?this.line2.legend:this.line.legend
				...
				let yAxisObj = this.line2?this.line2.yAxis:this.line.yAxis
				yAxisObj.type = 'value'
				...
				seriesObj = Object.assign(seriesObj , this.line2?this.line2.series:this.line.series)
				...
				option = {
					backgroundColor: this.line2?this.line2.backgroundColor:this.line.backgroundColor,
					color: this.line2?this.line2.color:this.line.color,
					title: titleObj,
					legend: legendObj,
					tooltip: tooltipObj,
					grid: gridObj,
				...
				// 使用刚指定的配置项和数据显示图表。
				shangpinxinxiChart5.setOption(option);
				

				  //根据窗口的大小变动图表
				window.addEventListener('resize', () => {
					shangpinxinxiChart5.resize();
				},false);
			}else{
				this.$message({
					message: data.msg,
...
//统计接口1
			gouwurizhiChat2() {
				this.$nextTick(()=>{
					...
					var gouwurizhiChart2 = echarts.init(document.getElementById("gouwurizhiChart2"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							for(let i=0;i<res.length;i++){
								...
								xAxis.push(res[i].userbehavior);
								yAxis.push(parseFloat((res[i].total)));
								pArray.push({
									value: parseFloat((res[i].total)),
									name: res[i].userbehavior
								})
							}
							var option = {};
							...
							// 使用刚指定的配置项和数据显示图表。
							gouwurizhiChart2.setOption(option);
				

							//根据窗口的大小变动图表
							window.addEventListener('resize', () => {
								gouwurizhiChart2.resize();
							},false);
						}else{
							this.$message({
								message: data.msg,
...
<style lang="scss" scoped>
	...
	.el-table /deep/ .el-table__header-wrapper thead tr {
				background: rgba(0,205,215,0);
			}
	
	.el-table /deep/ .el-table__header-wrapper thead tr th {
				padding: 6px 0;
				background: none;
				border-color: rgba(37,135,17,.2);
