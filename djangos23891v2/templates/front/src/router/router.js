...
import gouwurizhiList from '../pages/gouwurizhi/list'
import gouwurizhiDetail from '../pages/gouwurizhi/detail'
import gouwurizhiAdd from '../pages/gouwurizhi/add'
      ...
      redirect: '/index/home'
    },
		{
			...
			children:[
				...
				{
					path: 'gouwurizhi',
					component: gouwurizhiList
				},
				{
					path: 'gouwurizhiDetail',
					component: gouwurizhiDetail
				},
				{
					path: 'gouwurizhiAdd',
					component: gouwurizhiAdd
				},
				{
					path: 'chargerecord',
