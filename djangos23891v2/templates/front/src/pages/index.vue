	...
	<div class="main-containers">
		<div class="body-containers">
			<div class="top-container">
				<!-- info -->
				<div class="top_title">
					<span @click="goMenu('/index/home')">基于Python的电商用户行为分析系统</span>
				</div>
				...
				<el-dropdown class="dropdown-box" @command="handleCommand" trigger="click">
					...
					<el-dropdown-menu class="top-el-dropdown-menu" slot="dropdown">
						...
						<el-dropdown-item v-if="Token && notAdmin" class="user-item" :command="'user'">
							<span class="icon iconfont icon-geren11"></span>
							个人中心
						</el-dropdown-item>
						<el-dropdown-item v-if="Token" class="register-item" :command="'register'">
				...
				.menu-list {
					...
					.menu-home {
						...
						.title {
							...
							margin: -20px;
							color: #fff;
							background: url(http://codegen.caihongy.cn/20240918/7509cb4b6b664006a55ead57326a198a.png) no-repeat center top / 100% 100%;
							display: flex;
