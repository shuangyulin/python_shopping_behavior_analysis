...
for i in os.listdir(mainDir):
    if i not in excludeList and i[-5:] == "_v.py":
        ...
        if tableName.lower()=="shangpinxinxi":
            urlpatterns.extend(
                  [
                  path(r'{}/value/<xColumnName>/<yColumnName>/<timeStatType>'.format(tableName.lower()),
                       eval("{}_v.{}_value".format(tableName.capitalize(), tableName.lower()))),
...
#批量生成数据
        if tableName.lower() == "shangpinxinxi":
            urlpatterns.extend(
                       [
                           path(r'{}/batch/gen'.format(tableName.lower()),
                                eval("{}_v.{}_batch_gen".format(tableName.capitalize(), tableName.lower())))
                       ]
                   )
        if tableName.lower() == "shangpinxinxi":
            urlpatterns.extend(
...
#批量生成数据
        ...
        if tableName.lower() == "chargerecord":
            urlpatterns.extend(
                [
                    path(r'{}/security'.format(tableName.lower()),
                         eval("{}_v.{}_security".format(tableName.capitalize(), tableName.lower()))),
        ...
        if tableName.lower() == "discussshangpinxinxi":
            urlpatterns.extend(
                [
                    path(r'{}/security'.format(tableName.lower()),
                         eval("{}_v.{}_security".format(tableName.capitalize(), tableName.lower()))),
...
urlpatterns.extend(
    [
        path(r'hive/analyze', hive_v.hive_analyze),
