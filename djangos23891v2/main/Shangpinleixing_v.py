...
def shangpinleixing_page(request):
    ...
    if request.method in ["POST", "GET"]:
        ...
        if  __isAdmin__ == "是" and 'shangpinleixing' != 'forum' :
            if req_dict.get("userid") and 'shangpinleixing' != 'chat' and 'shangpinleixing' != 'examrecord':
                del req_dict["userid"]
        else:
...
def shangpinleixing_query(request):
    '''
    '''
    if request.method in ["POST", "GET"]:
        msg = {"code": normal_code, "msg": mes.normal_code, "data": {}}
        try:
            query_result = shangpinleixing.objects.filter(**request.session.get("req_dict")).values()
...
def shangpinleixing_save(request):
    ...
    if request.method in ["POST", "GET"]:
        ...
        idOrErr= shangpinleixing.createbyreq(shangpinleixing,shangpinleixing, req_dict)
